...
public class CaptchaConfig {
	...
	public RandomWordGenerator wordgen() {
		RandomWordGenerator tor=new RandomWordGenerator("aabbccddeefgghhkkmnnooppqqsstuuvvwxxyyzz");
		return tor;
	}
	...
	public UniColorBackgroundGenerator backGenUni() {
		UniColorBackgroundGenerator tor=new UniColorBackgroundGenerator(110,60);
		return tor;
	}
