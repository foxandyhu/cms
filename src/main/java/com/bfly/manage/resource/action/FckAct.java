...
import com.bfly.common.fck.Command;
import com.bfly.common.fck.ResourceType;
import com.bfly.common.fck.UploadResponse;
import com.bfly.common.fck.Utils;
...
public class FckAct {
	...
	public void upload(
		...
		UploadResponse ur = validateUpload(request, commandStr, typeStr,
				currentFolderStr);
		if (ur == null) {
			ur = doUpload(request, typeStr, mark);
		}
	...
	private UploadResponse doUpload(HttpServletRequest request, String typeStr,Boolean mark) throws Exception {
