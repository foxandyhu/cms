//package com.bfly.web.sms.action;
//
...
//import com.bfly.cms.sms.entity.SmsConfig;
//import com.bfly.cms.sms.entity.SmsRecord;
...
//        SysConfig config = site.getConfig();
...
//    }
//
//    private WebErrors validateRegister(SysConfig config, String smsId,
...
//     * @return: WebErrors
//     */
//    private WebErrors validateForgotPassword(SysConfig config, String smsId,
...
//        } else {
//            //判断手机号与用户名是否匹配
//            Member user = unifiedUserMng.getByUsername(username);
//            Member user2 = cmsUserMng.findByUsername(username);
//            MemberExt userExt = null;
//            if (user2 != null) {
...
//    }
//
//    private WebErrors validateSMS(SysConfig config, String mobilePhone, WebErrors errors, String smsId) {
//        //判断手机号每日限制是否已达标
//        List<SmsRecord> findByPhone = smsRecordManager.findByPhone(mobilePhone);
//        Integer dayCount = 0;
...
//    }
//
//    private WebErrors sendByALi(SmsConfig bean, String mobilePhone, String values, WebErrors errors, Site site, String username, Integer smsSendType) {
//        try {
...
//     * @return: WebErrors
//     */
//    private WebErrors sendByBaiDu(SmsConfig bean, String mobilePhone, String values, WebErrors errors, Site site, String username, Integer smsSendType) {
//
//        // 发送请求
...
//     * @return
//     */
//    private WebErrors sendByTX(SmsConfig bean, String mobilePhone, String values, WebErrors errors, Site site, String username, Integer smsSendType) {
//        try {
