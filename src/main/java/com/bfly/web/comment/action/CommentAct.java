...
//            rec = null;
//        }
//        List<Comment> list = cmsCommentMng.getListForTag(contentId, parentId, greatTo, checked, rec, desc, 0, count);
//        model.putAll(RequestUtils.getQueryParams(getRequest()));
...
//    }
//
//    private boolean hasCommented(Member user, Content content) {
...
//            return false;
//        }
//        Comment comment = cmsCommentMng.findById(id);
//        return comment != null;
//    }
//
//    @Autowired
