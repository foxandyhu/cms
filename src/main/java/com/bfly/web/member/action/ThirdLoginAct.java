...
//            switch (source) {
//                case MemberThirdAccount.QQ_PLAT:
//                    getSession().setAttribute(MemberThirdAccount.QQ_KEY, key);
//                    break;
//                case MemberThirdAccount.QQ_WEBO_PLAT:
//                    getSession().setAttribute(MemberThirdAccount.QQ_WEBO_KEY, key);
//                    break;
//                case MemberThirdAccount.SINA_PLAT:
//                    getSession().setAttribute(MemberThirdAccount.SINA_KEY, key);
//                    break;
//                default:
//            }
//
...
//        } else {
//            Member u = unifiedUserMng.getByUsername(username);
//            boolean passwordValid = unifiedUserMng.isPasswordValid(u.getId(), password);
//            if (!passwordValid) {
//                errors.addErrorCode("error.passwordInvalid");
//            } else {
//                //获取用户来源
//                String openId = (String) getSession().getAttribute(MemberThirdAccount.QQ_KEY);
//                String uid = (String) getSession().getAttribute(MemberThirdAccount.SINA_KEY);
//                String weboOpenId = (String) getSession().getAttribute(MemberThirdAccount.QQ_WEBO_KEY);
//                String weixinOpenId = (String) getSession().getAttribute(MemberThirdAccount.WEIXIN_KEY);
//                if (StringUtils.isNotBlank(openId)) {
//                    source = MemberThirdAccount.QQ_PLAT;
//                } else if (StringUtils.isNotBlank(uid)) {
//                    source = MemberThirdAccount.SINA_PLAT;
//                } else if (StringUtils.isNotBlank(weboOpenId)) {
//                    source = MemberThirdAccount.QQ_WEBO_PLAT;
//                } else if (StringUtils.isNotBlank(weixinOpenId)) {
//                    source = MemberThirdAccount.WEIXIN_PLAT;
//                }
//                //提交登录并绑定账号
...
//                        SysConfig config = cmsConfigMng.get();
//                        Site site = getSite();
...
//                    MemberThirdAccount account = accountMng.findByKey(md5OpenId);
//                    if (account != null) {
//                        //已绑定直接登陆
...
//                        getSession().setAttribute(MemberThirdAccount.WEIXIN_KEY, openid);
//                        return renderPage("member/bind.html", model);
...
//        Member user = cmsUserMng.findByUsername(username);
...
//            //绑定账户
//            bind(username, openId, MemberThirdAccount.QQ_PLAT);
//        }
//        if (StringUtils.isNotBlank(uid)) {
//            loginShiro(response, username);
//            //绑定账户
//            bind(username, uid, MemberThirdAccount.SINA_PLAT);
//        }
//        if (StringUtils.isNotBlank(weboOpenId)) {
//            loginShiro(response, username);
//            //绑定账户
//            bind(username, weboOpenId, MemberThirdAccount.QQ_WEBO_PLAT);
//        }
//        if (StringUtils.isNotBlank(weixinOpenId)) {
//            loginShiro(response, username);
//            //绑定账户
//            bind(username, weixinOpenId, MemberThirdAccount.WEIXIN_PLAT);
//        }
//    }
//
//    /**
