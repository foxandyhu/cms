...
//    public String submit(String username, String email, String loginPassword, MemberExt userExt, String captcha, String nextUrl, HttpServletRequest request, HttpServletResponse response, ModelMap model) throws IOException {
//        Site site = getSite();
...
//    }
//
//    private WebErrors validateSubmit(String username, String email, String loginPassword, String captcha, Site site, HttpServletRequest request) {
