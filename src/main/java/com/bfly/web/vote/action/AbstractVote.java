...
//
//
//    protected VoteTopic voteByApi(Member user, Integer voteId, Integer[] subIds, List<Integer[]> itemIds, Integer[] subTxtIds, String[] reply, HttpServletRequest request, HttpServletResponse response, ModelMap model) {
//        String ip = RequestUtils.getIpAddr(request);
//        String cookieName = VoteTopic.VOTE_COOKIE_PREFIX + voteId;
...
//
//
//    protected boolean validateSubmit(Integer topicId, Integer[] subIds, List<Integer[]> itemIds, String[] replys, Member user, String ip, String cookie, ModelMap model) {
//        // 投票ID不能为空
//        if (topicId == null) {
//            model.addAttribute("status", VoteTopic.VOTE_STATUS_ID_NULL);
//            return true;
//        }
//        // 投票项不能为空
//        if (subIds == null || subIds.length <= 0 || itemIds == null || itemIds.size() <= 0) {
//            model.addAttribute("status", VoteTopic.VOTE_STATUS_ITEM_NULL);
//            return true;
//        }
//        // 非文本选项 投票项不能为空
...
//            if (hasSensitive) {
//                model.addAttribute("status", VoteTopic.VOTE_STATUS_HAS_SENSITIVE);
//                return true;
//            }
//        }
...
//        // 投票主题不存在
//        if (topic == null) {
//            model.addAttribute("status", VoteTopic.VOTE_STATUS_NOT_FOUND);
//            return true;
//        }
//        // 投票项不合法
...
//            }
//            if (!contains) {
//                model.addAttribute("status", VoteTopic.VOTE_STATUS_ITEM_ILLEGAL);
//                return true;
//            }
//        }
//
...
//            model.addAttribute("status", VoteTopic.VOTE_STATUS_CLOSED);
//            return true;
//        }
...
//            model.addAttribute("status", VoteTopic.VOTE_STATUS_NOT_BEGIN);
...
//            model.addAttribute("status", VoteTopic.VOTE_STATUS_ENDED);
...
//                if ((hour == null && vtime != null) || (hour != null && vtime.getTime() + hour * 60 * 60 * 1000 > now)) {
//                    model.addAttribute("status", VoteTopic.VOTE_STATUS_LIMIT_IP_REPEAT);
//                    return true;
//                }
//            }
...
//                if ((hour == null && vtime != null) || (hour != null && vtime.getTime() + hour * 60 * 60 * 1000 > now)) {
//                    model.addAttribute("status", VoteTopic.VOTE_STATUS_LIMIT_COOKIE_REPEAT);
//                    return true;
//                }
//            }
//        }
