...
//        }
//        Member user = userMng.findByUsername(username);
//        if (user != null) {
//            if (user.getDisabled()) {
...
//     * @date 2018/11/28 16:08
//     */
//    private boolean isActive(Member user) {
...
//     */
//    private boolean isChecked(Member user) {
//        return Member.USER_STATU_CHECKED.equals(user.getStatu());
//    }
//
//
//    @Autowired
