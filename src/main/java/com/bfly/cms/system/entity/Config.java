...
public class Config implements Serializable {
    ...
    public static class ConfigMessageTemplate implements MessageTemplate {
        private static String MESSAGE_FORGOT_PASSWORD_SUBJECT = "message_forgotpassword_subject";
        private static String MESSAGE_FORGOT_PASSWORD_TEXT = "message_forgotpassword_text";
        private static String MESSAGE_REGISTER_SUBJECT = "message_register_subject";
        private static String MESSAGE_REGISTER_TEXT = "message_register_text";

        private Map<String, String> attr;

        public static ConfigMessageTemplate createForgotPasswordMessageTemplate(Map<String, String> map) {
            if (map == null || StringUtils.isBlank(map.get(MESSAGE_FORGOT_PASSWORD_SUBJECT))
                    || StringUtils.isBlank(map.get(MESSAGE_FORGOT_PASSWORD_TEXT))) {
                // 信息不完整，返回null。
                return null;
            }
        ...
        public String getForgotPasswordSubject() {
            return getAttr().get(MESSAGE_FORGOT_PASSWORD_SUBJECT);
        }

        public void setForgotPasswordSubject(String subject) {
            getAttr().put(MESSAGE_FORGOT_PASSWORD_SUBJECT, subject);
        }

        @Override
        public String getForgotPasswordText() {
            return getAttr().get(MESSAGE_FORGOT_PASSWORD_TEXT);
        }

        public void setForgotPasswordText(String text) {
            getAttr().put(MESSAGE_FORGOT_PASSWORD_TEXT, text);
        }
