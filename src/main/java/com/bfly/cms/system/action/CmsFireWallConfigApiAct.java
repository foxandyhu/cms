...
public class CmsFireWallConfigApiAct {
    ...
    public void update(String open, String valPassword,
        ...
        if (!errors.hasErrors()) {
            boolean result = validatePassword(valPassword, request, response);
            if (!result) {
    ...
    private boolean validatePassword(String password, HttpServletRequest request, HttpServletResponse response) {
