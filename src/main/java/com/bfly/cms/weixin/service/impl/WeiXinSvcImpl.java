...
public class WeiXinSvcImpl implements WeiXinSvc {
    ...
    public Map<String, String> getToken() {
        ...
        if (site != null) {
            appid = site.getAttr().get(Constants.WEIXIN_APPKEY);
            secret = site.getAttr().get(Constants.WEIXIN_APPSECRET);
        }
