...
import com.bfly.cms.service.WeixinTokenCache;
...
public class WeiXinSvcImpl implements WeiXinSvc {
    ...
    public Map<String, String> getToken() {
        ...
        if (site != null) {
            appid = site.getAttr().get(com.bfly.core.Constants.WEIXIN_APPKEY);
            secret = site.getAttr().get(com.bfly.core.Constants.WEIXIN_APPSECRET);
        }
