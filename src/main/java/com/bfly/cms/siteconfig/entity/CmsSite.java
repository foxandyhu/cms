...
public class CmsSite implements Serializable {
    ...
    public String getWxAppkey() {
        String wxAppkey = getAttr().get(Constants.WEIXIN_APPKEY);
        return wxAppkey;
    }

    public String getWxAppSecret() {
        String wxAppSecret = getAttr().get(Constants.WEIXIN_APPSECRET);
        return wxAppSecret;
    }

    public String getWxToken() {
        String wxToken = getAttr().get(Constants.WEIXIN_TOKEN);
        return wxToken;
    }
