...
import com.bfly.cms.entity.main.Channel.AfterCheckEnum;
...
import com.bfly.core.web.ContentInterface;
...
public class Content implements ContentInterface, Serializable {
    ...
    @ManyToMany
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region = "beanCache")
    @JoinTable(name = "jc_content_channel", joinColumns = @JoinColumn(name = "content_id", referencedColumnName = "content_id"), inverseJoinColumns = @JoinColumn(name = "channel_id", referencedColumnName = "channel_id"))
    private Set<Channel> channels;

    @ManyToMany
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region = "beanCache")
    @JoinTable(name = "jc_content_topic", joinColumns = @JoinColumn(name = "content_id", referencedColumnName = "content_id"), inverseJoinColumns = @JoinColumn(name = "topic_id", referencedColumnName = "topic_id"))
    private Set<CmsTopic> topics;

    @ManyToMany
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region = "beanCache")
    @JoinTable(name = "jc_content_group_view", joinColumns = @JoinColumn(name = "content_id", referencedColumnName = "content_id"), inverseJoinColumns = @JoinColumn(name = "group_id", referencedColumnName = "group_id"))
    private Set<CmsGroup> viewGroups;

    @ManyToMany
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region = "beanCache")
    @JoinTable(name = "jc_contenttag", joinColumns = @JoinColumn(name = "content_id", referencedColumnName = "content_id"), inverseJoinColumns = @JoinColumn(name = "tag_id", referencedColumnName = "tag_id"))
    ...
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region = "beanCache")
    @CollectionTable(name = "jc_content_picture", joinColumns = @JoinColumn(name = "content_id", referencedColumnName = "content_id"))
    ...
    @OrderColumn(name = "priority")
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region = "beanCache")
    @CollectionTable(name = "jc_content_attachment", joinColumns = @JoinColumn(name = "content_id", referencedColumnName = "content_id"))
    ...
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region = "beanCache")
    @OneToOne(mappedBy = "content", cascade = CascadeType.REMOVE, orphanRemoval = true)
    private ContentCharge contentCharge;

    @OneToMany(cascade = CascadeType.REMOVE, orphanRemoval = true, mappedBy = "content")
    private Set<ContentBuy> contentBuySet;
    ...
    @ManyToMany
    @JoinTable(name = "jc_user_collection", joinColumns = @JoinColumn(name = "content_id", referencedColumnName = "content_id"), inverseJoinColumns = @JoinColumn(name = "user_id", referencedColumnName = "user_id"))
    ...
    @OneToMany(mappedBy = "content", cascade = CascadeType.REMOVE, orphanRemoval = true)
    private Set<CmsScoreRecord> scoreRecordSet;
    ...
    @OrderColumn(name = "priority")
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region = "beanCache")
    @CollectionTable(name = "jc_content_reward_fix", joinColumns = @JoinColumn(name = "content_id", referencedColumnName = "content_id"))
    private List<ContentRewardFix> rewardFixs;
    ...
    public Set<CmsScoreRecord> getScoreRecordSet() {
        return scoreRecordSet;
    }

    public void setScoreRecordSet(
            Set<CmsScoreRecord> scoreRecordSet) {
    ...
    public List<ContentRewardFix> getRewardFixs() {
        return rewardFixs;
    }

    public void setRewardFixs(List<ContentRewardFix> rewardFixs) {
    ...
    public Set<ContentBuy> getContentBuySet() {
        return contentBuySet;
    }

    public void setContentBuySet(Set<ContentBuy> contentBuySet) {
...
//			return getUrlDynamic(null);
    ...
    public JSONObject convertToJson(Integer format, Integer https,
        ...
        String urlPrefix = "";
        if (getChannel() != null) {
            if (https == com.bfly.cms.api.Constants.URL_HTTP) {
