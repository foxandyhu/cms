...
import com.bfly.plug.weixin.manager.WeixinMng;
...
public class WeixinApiAct {
	...
	public void config(Weixin bean,String wxAppkey,String wxAppSecret,
		...
		if(!StringUtils.isBlank(wxAppkey)){
			wxMap.put(com.bfly.core.Constants.WEIXIN_APPKEY, wxAppkey);
		}
		if(!StringUtils.isBlank(wxAppSecret)){
			wxMap.put(com.bfly.core.Constants.WEIXIN_APPSECRET, wxAppSecret);
		}
		if(!StringUtils.isBlank(wxToken)){
			wxMap.put(com.bfly.core.Constants.WEIXIN_TOKEN, wxToken);
		}
