...
import com.bfly.cms.manager.assist.CmsDirectiveTplMng;
...
public class DirectiveApiAct {
	...
	private String getChannelTpl(Map<String,Object>params){
		...
		filename+= com.bfly.cms.Constants.DIRECTIVE_TPL_PATH+CHANNEL+"/";
		if(list){
	...
	private String getCommonTpl(Map<String,Object>params,String module){
		...
		filename+= com.bfly.cms.Constants.DIRECTIVE_TPL_PATH+module+"/";
		if(page){
	...
	private String getVoteTpl(Map<String,Object>params){
		String filename="";
		Boolean list=getBooleanParam(params, "list");
		filename+= com.bfly.cms.Constants.DIRECTIVE_TPL_PATH+VOTE+"/";
		if(list){
			filename+=LIST_PREFIX;
		}else{
			filename+=SINGLE_PREFIX;
	...
	private String getLinkTpl(Map<String,Object>params){
		return com.bfly.cms.Constants.DIRECTIVE_TPL_PATH+LINK+"/"+LIST_PREFIX+TPL_SUFFIX;
	}
	...
	private String getContentTpl(Map<String,Object>params){
		...
		filename+= com.bfly.cms.Constants.DIRECTIVE_TPL_PATH+CONTENT+"/";
