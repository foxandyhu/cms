...
import static com.bfly.cms.Constants.TPLDIR_INDEX;
import static com.bfly.cms.Constants.TPL_BASE;
...
import com.bfly.core.tpl.FileTpl;
...
//		JsonObject json=new JsonObject();
	...
	public void save(String root, String filename, String source,
		...
		if(!errors.hasErrors()){
			String name = root + "/" + filename + com.bfly.cms.Constants.TPL_SUFFIX;
