package com.bfly.cms.staticpage.dao.impl;
...
import com.bfly.cms.staticpage.dao.StaticPageDao;
 ...
 */
@Repository
public class StaticPageDaoImpl extends AbstractHibernateDao implements
        StaticPageDao {
    @Override
    public int channelStatic(HttpServletRequest request, HttpServletResponse response,
        ...
        if (request != null && response != null) {
            request.getSession().setAttribute(Constants.STATIC_TOTAL_COUNT_KEY, totalCount);
        }
        ...
        while (channels.next()) {
            ...
            if (request != null && response != null) {
                request.getSession().setAttribute(Constants.STATIC_CURR_COUNT_KEY, count);
            }
        }
        if (es != null) {
            es.shutdown();
