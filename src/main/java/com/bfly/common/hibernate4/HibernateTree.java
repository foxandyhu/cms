...
public interface HibernateTree<T extends Number> {
     ...
     * 默认树左边属性名称
     */
    static final String DEF_LEFT_NAME = "lft";

    /**
     * 默认树右边属性名称
     */
    static final String DEF_RIGHT_NAME = "rgt";

    /**
     * 默认父节点属性名称
     */
    static final String DEF_PARENT_NAME = "parent";
    /**
     * 实体类别名
     */
    static final String ENTITY_ALIAS = "bean";
