package com.bfly.admin.staticpage.action;
...
public class StaticApiAct {
    ...
    public void getProgress(
        ...
        Integer progress = 0;
        Object total = request.getSession().getAttribute(Constants.STATIC_TOTAL_COUNT_KEY);
        Object curr = request.getSession().getAttribute(Constants.STATIC_CURR_COUNT_KEY);
        if (total != null) {
