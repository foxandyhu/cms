package com.bfly.admin.words.action;
...
public class ContentTagAdminApiAct {
    private static final Logger log = LoggerFactory.getLogger(ContentTagAdminApiAct.class);
