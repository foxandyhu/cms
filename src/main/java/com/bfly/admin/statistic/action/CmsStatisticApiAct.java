package com.bfly.admin.statistic.action;
...
import com.bfly.cms.statistic.entity.CmsStatistic;
import com.bfly.cms.statistic.entity.CmsStatistic.*;
import com.bfly.cms.statistic.service.CmsStatisticSvc;
...
import static com.bfly.cms.statistic.entity.CmsSiteAccessStatistic.*;
import static com.bfly.cms.statistic.entity.CmsStatistic.*;
...
public class CmsStatisticApiAct {
    ...
    public void channelList(Integer channelLevel, String view,
        ...
        for (int i = 0; i < list.size(); i++) {
            JSONObject json = list.get(i).convertToJson(Constants.URL_HTTP, false, false, null);
